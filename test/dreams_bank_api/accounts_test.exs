defmodule DreamsBankApi.AccountsTest do
  ...
  describe "accounts" do
    ...
    import DreamsBankApi.AccountsFixtures
    ...
    test "create_account/1 with valid data creates a account" do
      valid_attrs = %{owner: "some owner", number: "some number", balance: "120.5"}
    ...
    test "update_account/2 with valid data updates the account" do
      account = account_fixture()
      update_attrs = %{owner: "some updated owner", number: "some updated number", balance: "456.7"}
